...
`princomp()` performs a principal components analysis on the given numeric data matrix and returns the results as an object of class princomp. It contains the arguments: formula, data, subset, na.action, x, cor, scores, covmat, fix_sign, object, newdata
