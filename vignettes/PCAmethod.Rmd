...
#knitr::opts_chunk$set(
 ...
 # comment = "#>"
#)
knitr::opts_chunk$set(collapse=TRUE, comment="#>", echo = TRUE, fig.width = 8, fig.height = 8)
```
...
removes rows (songs) containing NA values. `length()` tells us how many songs 
...
this to the most explanatory PCs using `select()`

```{r}
loadings(pc |> select(Comp.1, Comp.2, Comp.3, Comp.4))
```
